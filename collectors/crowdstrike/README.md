...
Template (CFT) for deploying a log collector in AWS which will poll the CrowdStrike Alerts API to collect and 
...
### 2. API Docs
1. [General Document](https://developer.crowdstrike.com/docs/)
